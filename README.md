...
สี่เลเยอร์แรกนำเข้ามาจาก namphraesmartcity.ai ถนนต้องใช้คีย์ประกอบเพราะถนนเส้นเดียว
ที่พาดผ่านสองหมู่ถูกตัดเป็นคนละแถวตอน clip (`full_id` อย่างเดียวซ้ำ 138 แถว) ส่วนอาคาร
ไม่ตั้งคีย์เพราะ `OBJECTID` ถูก ArcGIS แจกใหม่ทุกรอบ export
